bossbar remove pvp_01
bossbar remove pvp_02
bossbar remove pvp_03
bossbar remove pvp_04
bossbar remove pvp_05
bossbar remove pvp_06
bossbar remove pvp_07
bossbar remove pvp_08
...
scoreboard players set phantom_of_the_tazkisaba pvp_game 0