execute if entity @a[scores={kelp_dest_check=1}] at @e[type=item,nbt={Age:0s,Item:{id:"minecraft:kelp"}},predicate=tazki:in_water] align xyz run summon armor_stand ~0.5 ~ ~0.5 {Tags:[block_check],Small:true,NoGravity:true,Invisible:false,Marker:true}

execute if entity @a[scores={kelp_plant_dest_check=1}] at @e[type=item,nbt={Age:0s,Item:{id:"minecraft:kelp"}},predicate=tazki:in_water] align xyz run summon armor_stand ~0.5 ~ ~0.5 {Tags:[block_check],Small:true,NoGravity:true,Invisible:false,Marker:true}
